...
/* AccËs aux donnÈees concernant la table Games, History, Messages */
...
function loadGame($gameID, $numMoves)
{
	...
	if ($dateLastMove < $dateNow)
	{
		...
		// Dans cas lastMove est mis ‡†jour pour prise en compte calcul Elo
...
function saveGame()
{
	// TODO VÈrifier impact $ecoCode, $ecoName
...
/* Utilis√© dans l'√©cran d'une partie */

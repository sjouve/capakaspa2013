<?
	session_start();
	$titre_page = 'Les sites et les livres aux sujets des échecs';
    require 'page_header.php';
    
	$image_bandeau = 'bandeau_capakaspa_global.jpg';
    $barre_progression = "Découvrir les échecs > Sites & Livres";
	...
	<div id="onglet">
        <table width="680" cellpadding="0">
          <tr>
			...
			<td ><div class="ongletdisable">Ressources</div></td>
...
<div class="blogbody">
    ...
    /* CapaKaspa Ressources Droite */
    google_ad_slot = "9512681266";
    google_ad_width = 160;

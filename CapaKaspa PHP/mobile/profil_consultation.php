...
?>
	...
	<h3><img src="<?echo(getPicturePath($player['socialNetwork'], $player['socialID']));?>" width="50" height="50"/> Profil de <? echo($player['nick']); ?> <?if ($favorite) echo("<img src='images/favori-etoile-icone.png'/>");?></h3>

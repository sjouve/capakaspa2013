...
<div id="contentlarge">
    <div class="contentbody">
		...
		<p><?echo _("Improve your chess with some daily tactical puzzles. 3 levels available : Easy, Medium, Hard. It's up to you !");?></p>
		<br/>
		<center>
			...
			<?echo _("This option will not work correctly.  Unfortunately, your browser does not support Inline Frames")?>
			</iframe>
		</center>

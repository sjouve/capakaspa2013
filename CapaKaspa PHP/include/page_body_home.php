...
<div id="topbar">
	<div id="container">
		<span class="title" style="line-height: 100%;"><a href="http://www.capakaspa.info" title="<?php echo _("CapaKaspa : Chess for all");?>"><img src="http://www.capakaspa.info/wp-content/uploads/2017/08/CapaKaspa-Logo-Bandeau-Nom.png"/></a></span>
		...
		<br/>
		<span class="subtitle"><?php echo _("Play correspondence chess online and share your games");?></span>
	</div>
</div>

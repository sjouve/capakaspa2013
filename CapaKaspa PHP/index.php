				...
				<div class='activity'>
					...
					<div class='details'>
						...
						<div class='content'>
							...
							/* Response */
							echo ("<span style='float: left'><TEXTAREA name='respMessage' rows='3' placeholder="._("Join a message")." style='background-color: white;border-color: #CCCCCC;width: 260px;'></TEXTAREA></span>");
